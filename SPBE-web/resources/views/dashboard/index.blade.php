                                ...
                                <thead>
                                    <tr>
                                        <th
                                            ...
                                            Nama Instansi</th>
                                        <th
                                            class="w-1 text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                            </th>
                                        <th
                                ...
                                <tbody>
                                    <tr class="data-row" style="border-bottom: 2px dashed #000000; padding-bottom: 10px; background-color: #c0bdbd;">
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">Pemerintah Kota
                                                Malang</span>
                                        </td>
                                        <td class="align-middle text-sm">
                                    ...
                                    <tr class="data-row">
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">K/L/D</span>
                                        </td>
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">:</span>
                                        </td>
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">Pemerintah Kota</span>
                                        </td>
                                    </tr>
                                    <tr class="data-row" style="background-color: #c0bdbd;">
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">Indeks SPBE</span>
                                        </td>
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">:</span>
                                        </td>
                                    ...
                                    <tr class="data-row" style="border-bottom: 2px dashed #000000; padding-bottom: 10px; background-color: #c0bdbd;">
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">Predikat SPBE</span>
                                        </td>
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">:</span>
                                        </td>
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">Sangat Baik</span>
                                        </td>
                                    </tr>
                                    <tr class="data-row" style="background-color: #c0bdbd;">
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">Domain Kebijakan SPBE</span>
                                        </td>
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">:</span>
                                        </td>
                                    ...
                                    <tr class="data-row">
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">Kebijakan Internal Terkait Tata Kelola SPBE</span>
                                        </td>
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">:</span>
                                        </td>
                                    ...
                                    <tr class="data-row" style="background-color: #c0bdbd;">
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">Domain Tata Kelola SPBE</span>
                                        </td>
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">:</span>
                                        </td>
                                    ...
                                    <tr class="data-row">
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">Perencanaan Strategis SPBE</span>
                                        </td>
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">:</span>
                                        </td>
                                    ...
                                    <tr class="data-row">
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">Teknologi Informasi dan Komunikasi</span>
                                        </td>
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">:</span>
                                        </td>
                                    ...
                                    <tr class="data-row">
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">Penyelanggara SPBE</span>
                                        </td>
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">:</span>
                                        </td>
                                    ...
                                    <tr class="data-row" style="background-color: #c0bdbd;">
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">Domain Manajemen SPBE</span>
                                        </td>
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">:</span>
                                        </td>
                                    ...
                                    <tr class="data-row">
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">Penerapan Manajemen SPBE</span>
                                        </td>
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">:</span>
                                        </td>
                                    ...
                                    <tr class="data-row">
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">Audit TIK</span>
                                        </td>
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">:</span>
                                        </td>
                                    ...
                                    <tr class="data-row" style="background-color: #c0bdbd;">
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">Domain Layanan SPBE</span>
                                        </td>
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">:</span>
                                        </td>
                                    ...
                                    <tr class="data-row">
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">Layanan Administrasi Pemerintah Berbasis Elektronik</span>
                                        </td>
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">:</span>
                                        </td>
                                    ...
                                    <tr class="data-row">
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">Layanan Publik Berbasi Elektronik</span>
                                        </td>
                                        <td class="align-middle text-sm">
                                            <span class="text-secondary text-xs font-weight-bold">:</span>
                                        </td>
