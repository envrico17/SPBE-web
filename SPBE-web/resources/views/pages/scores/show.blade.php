                        ...
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <div class="d-flex flex-row justify-content-between align-items-center">
                                    <h6 class="text-white text-capitalize ps-3">{{ $score->score_name }}</h6>
                                </div>
                            </div>
                        </div>
                                        ...
                                        @forelse ($attributes as $attribute)
                                            <tr class="data-row">
                                                ...
                                                <td class="align-middle text-sm">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">{{ $attribute->indicator->indicator_name }}</span>
                                                </td>
                                                {{-- Score --}}
                                                <td class="align-middle text-sm">
                                                    <span
                                                ...
                                                <td class="">
                                                    <div class="align-middle text-center">
                                                        <a href="javascript:;"
                                                            ...
                                                            <i class="bi bi-journal-check mx-2"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="container">
                                                                        ...
                                                                        <div class="row mb-3">
                                                                            ...
                                                                            <div class="col-sm-auto fw-bold">:</div>
                                                                            <div class="col-sm-8">
                                                                                {{ $attribute->indicator->indicator_name }}
                                                                            </div>
                                                                        </div>
                                                                        <div class="row mb-3">
                                                                            <div class="col-sm-3 text-start fw-bold">
                                                                            ...
                                                                            <div class="col-sm-auto fw-bold">:</div>
                                                                            <div class="col-sm-5">
                                                                                {!! $attribute->indicator->description !!}</div>
                                                                        </div>
                                                                        <form
                                                                            action="{{ route('score.update', ['score' => $score->id, 'id' => $attribute->id]) }}"
                                                                            method="POST">
                                                                            @csrf
                                                                            @method('PUT')
                                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="container">
                                                                        ...
                                                                        <ul>
                                                                            @foreach ($attribute->indicator->documents as $document)
